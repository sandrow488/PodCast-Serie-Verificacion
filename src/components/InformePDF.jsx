...
export default function InformePDF() {
  ...
  return (
    <div className="bg-white min-h-screen py-6 px-4">
      <div className="max-w-3xl mx-auto mb-6 flex flex-col sm:flex-row justify-between items-center border border-black bg-white p-3 gap-3">
      ...
      <article
        ref={contentRef}
        id="informe-pdf"
        className="max-w-3xl mx-auto bg-white text-black font-sans leading-relaxed border border-black p-8"
      >
        <header className="mb-6 border-b border-black pb-3">
          <h1 className="text-2xl font-bold mb-1 text-black">INFORME DE ACCESIBILIDAD</h1>
          <h2 className="text-base mb-4 text-black">Proyecto React</h2>
          <div className="text-sm mt-3 grid grid-cols-1 sm:grid-cols-2 gap-1 bg-white p-3 border border-black">
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">ENLACES DEL PROYECTO</h3>
          <ul className="mb-6 pl-5 space-y-1 text-black list-none">
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">INTRODUCCIÓN</h3>
          ...
          <p className="mb-2 text-black">Para hacer esta auditoría he utilizado:</p>
          <ul className="list-none mb-3 text-black">
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">ESTRUCTURA DEL PROYECTO</h3>
          <p className="mb-4 text-black">
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">TESTEO INICIAL</h3>
          <h4 className="font-bold underline mb-2 text-black">Resultados de Lighthouse</h4>
          <p className="mb-3 italic text-black font-semibold">Nota inicial: 71/100.</p>
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">FALLOS ENCONTRADOS</h3>
          <ul className="list-none space-y-2 text-black">
            <li><strong>Mal uso del HTML:</strong> Tenía casi todo metido dentro de etiquetas genéricas div, lo que está mal porque hay que usar header, nav, main o footer para que tenga sentido.</li>
            <li><strong>Imágenes sueltas:</strong> Faltaba el atributo "alt" en las fotos, y sin eso las personas que usan lectores de pantalla no saben de qué trata la imagen.</li>
            <li><strong>Poco contraste:</strong> Algunos textos sobre fondos claros no se podían leer muy bien.</li>
            <li><strong>Formularios rotos:</strong> Los campos del formulario de contacto no estaban vinculados a su "label", con lo cual era difícil rellenarlos usando tecnología de asistencia.</li>
            <li><strong>Foco invisible:</strong> Si apretabas el tabulador en vez de usar el ratón, te perdías porque no sabías dónde estabas.</li>
          </ul>
        </section>

        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">SOLUCIONES APLICADAS</h3>
          <ul className="list-none space-y-2 text-black">
            <li><strong>Arreglé las etiquetas HTML:</strong> Usé etiquetas semánticas y arreglé que el H1 del título fuera realmente un H1.</li>
            <li><strong>Formulario funcional:</strong> Ahora todos los inputs están vinculados, y los avisos de error los he preparado con "aria-live" para que el lector los anuncie.</li>
            <li><strong>Añadí el enlace Skip Link:</strong> Es un enlace oculto arriba del todo que deja a la gente saltarse el menú y pasar al contenido si usan teclado.</li>
            <li><strong>Movimiento reducido:</strong> Puse código CSS que detecta si el usuario de Windows o Mac tiene configurado "quitar animaciones" y, si es así, quita mis transiciones para no marear.</li>
            <li><strong>Arreglé los colores fuertes:</strong> Aumenté el contraste usando un tono violeta e índigo muy concreto porque tiene un ratio muy alto comparado con blanco.</li>
          </ul>
        </section>

        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">COMPROBACIÓN FINAL</h3>
          <p className="mb-4 text-black">
            Después de hacer todos mis commits y meter estas soluciones, volví a pasar Lighthouse por la web.
          </p>
          <p className="mb-4 text-black">
            <strong className="text-black text-base">Puntuación de ahora: 97/100.</strong>
          </p>
          <p className="mb-4 text-black text-justify">
        ...
        <section className="mb-8">
          <h3 className="text-base font-bold bg-white text-black p-1.5 mb-3 border-l-4 border-black">CONCLUSIÓN</h3>
          <p className="mb-4 text-black text-justify">
